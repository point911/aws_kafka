...
class ZookeeperCluster(BaseCluster):
    AWS_ZOOKEEPER_INVENTORY_GROUP = os.environ.get('AWS_ZOOKEEPER_INVENTORY_GROUP', None)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--delete-node', action='store_const', const=lambda: interface.delete_instance("NAME!!!"), dest='cmd')
